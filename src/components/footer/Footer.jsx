        ...
        <div className="flex container mx-auto flex-col md:flex-row justify-between items-center">
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            ...
            <p className="text-gray-400 mt-4">
              LD delivers top-quality real estate solutions, focused on your
              needs and satisfaction, helping you find your perfect property
              effortlessly.
            </p>
          </div>
          <div className="w-full md:w-1/5 mb-8 md:mb-0">
            ...
            <ul className="flex flex-col gap-2 text-gray-400">
              <a href="#Header" className="btn hover:text-white">
                Home
              </a>
              <a href="#About" className="btn hover:text-white">
                About
              </a>
              <a href="#Projects" className="btn hover:text-white">
                Projects
              </a>
              <a href="#Testimonials" className="btn hover:text-white">
                Testimonial
              </a>
            </ul>
          </div>
